...
if page == "🌐 Home":
    ...
    st.write("The Multi-Disease Prediction System is a smart healthcare application that uses Machine Learning models to analyze user health data and predict the likelihood of major diseases like Diabetes, Kidney Disease, and Heart Disease. It aims to promote early detection and awareness for better health decisions.")
